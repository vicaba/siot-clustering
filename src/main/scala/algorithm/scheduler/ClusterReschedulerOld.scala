...
object ClusterReschedulerOld {
  ...
  case class Settings(override val numberOfClusters: Int, override val metric: Metric, improvement: Double, memory: Int = 2) extends algorithm.algorithms.Settings
